...
const pageConfig: PageConfig = {
  ...
  links: [
    { link: 'https://github.com/Super-Yyt', label: 'GitHub' },
    { link: 'https://zhaishis.com/', label: '博客' },
  ],
}
...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    // },
    {
      ...
      name: '博客',
      method: 'HEAD',
      target: 'https://zhaishis.com',
      statusPageLink: 'https://zhaishis.com',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '每刻社区',
      method: 'HEAD',
      target: 'https://api.dy.ci',
      statusPageLink: 'https://dy.ci',
      hideLatencyChart: false,
      expectedCodes: [404],
      timeout: 10000,
    },
    {
      ...
      name: '乌托邦社区',
      method: 'HEAD',
      target: 'https://utopia.pm',
      statusPageLink: 'https://utopia.pm',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    ...
    },
    {
      ...
      name: '开源游戏官网',
      method: 'HEAD',
      target: 'https://www.osgames.cn',
      statusPageLink: 'https://www.osgames.cn',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '开源游戏仓库',
      method: 'HEAD',
      target: 'https://osgame.net',
      statusPageLink: 'https://osgame.net',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '每刻云盘',
      method: 'GET',
      target: 'https://fs.dy.ci',
      statusPageLink: 'https://fs.dy.ci',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '飞牛（NAS）',
      method: 'HEAD',
      target: 'https://zhaishis.fnos.net/',
      statusPageLink: 'https://zhaishis.fnos.net/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '悦教',
      method: 'HEAD',
      target: 'https://dlass.tech',
      statusPageLink: 'https://dlass.tech',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '每刻认证',
      method: 'HEAD',
      target: 'https://sso.dy.ci',
      statusPageLink: 'https://sso.dy.ci',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    }
  ...
  notification: {
    ...
    webhook: {
      ...
      payload: {
        "from": "系统状态更新 <uptimeflare@status.zhaishis.com>",
        "to": ["zhaishis@foxmail.com"],
